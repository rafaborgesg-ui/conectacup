  ...
  const steps: OnboardingStep[] = [
    {
      ...
      icon: Rocket,
      tip: 'Este sistema foi desenvolvido especificamente para a Conecta Cup, oferecendo controle total sobre o estoque de pneus.'
    },
    {
      id: 'dashboard',
    ...
    },
    {
      ...
      tip: 'A movimentação organiza fisicamente os pneus, mas não altera seu status (Novo/Pneu CUP/Descarte).',
    },
    {
      id: 'discard',
